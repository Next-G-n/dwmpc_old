...
var zapily = function(){
	...
	/*Sidebar Navigation*/
	$(document).on('click', '#toggle_nav_btn','#open_right_sidebar ','#open_profile','#setting_panel_btn', '#toggle_mobile_nav', function (e) {
	...
	$(document).on('click', '#open_right_sidebar ,#open_profile,#toggle_mobile_nav', function (e) {
		alert("Wee")
